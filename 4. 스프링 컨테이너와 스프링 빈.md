...
1. 스프링 컨테이너 생성
   ...
   ![스프링_컨테이너_생성과정1.png](./image/스프링_컨테이너_생성과정1.png)

2. 스프링 빈 등록

   - 스프링 컨테이너는 파라미터로 넘어온 설정 클래스 정보를 사용해서 스프링 빈을 등록한다.

   ![스프링_컨테이너_생성과정2.png](./image/스프링_컨테이너_생성과정2.png)

3. 스프링 빈 의존관계 설정 - 준비

   ![스프링_컨테이너_생성과정3.png](./image/스프링_컨테이너_생성과정3.png)
...
4. 스프링 빈 의존관계 설정 - 완료
   ...
   ![스프링_컨테이너_생성과정4.png](./image/스프링_컨테이너_생성과정4.png)

**참고**

스프링은 빈을 생성하고, 의존관계를 주입하는 단계가 나누어져 있다. 그런데 이렇게 자바 코드를 스프링 빈을 등록하면 생성자를 호출하면서 의존관계도 한번에 처리된다.
...
![BeanFactory와_ApplicationContext.png](./image/BeanFactory와_ApplicationContext.png)
...
![ApplicationContext_부가기능.png](./image/ApplicationContext_부가기능.png)
...
- 최근에는 스프링 부트를 많이 사용하면서 XML 기반의 설정은 잘 사용하지 않는다. 아직 많은 레거시 프로젝트들이 XML로 되어 있고, XML을 사용하면 컴파일 없이 빈 설정 정보를 변경할 수 있는 장점도 있으므로 배워두는 것도 괜찮다.
...
![BeanDefinition1.png](./image/BeanDefinition1.png)

**코드 레벨로 조금 더 깊이 있게 들어가보자.**

![BeanDefinition2.png](./image/BeanDefinition2.png)
...
- BeanDefinition을 직접 생성해서 스프링 컨테이너에 등록할 수 도 있다.
  - 하지만 실무에서 BeanDefinition을 직접 정의하거나 사용할 일이 거의 없다.
  - (김영한님은 어려우면 그냥 넘어가라고 하신다.)
